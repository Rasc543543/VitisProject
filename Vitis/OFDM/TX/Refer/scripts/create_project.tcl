...
# ---- 每個專案修改這裡 ----
set project_name  "ref_tx"
set top_func      "reference_signal_tx_packed"
...
add_files "$root_dir/reference_signal_tx_packed.cpp" \
    -cflags "-I$root_dir"

add_files -tb "$root_dir/tb_reference_signal_tx_packed.cpp" \
    -cflags "-I$root_dir" \
